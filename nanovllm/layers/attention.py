...
def _get_store_kvcache_kernel():
    """Define the Triton KV-cache store kernel lazily.

    Like flash-attn, triton is not needed to merely import the package;
    only the decode path that writes into a paged KV cache runs this kernel.
    """
    import triton
